    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      <div>
        ...
        {roomsDummyData.map((room) => (
          ...
          py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-border-0">
            <img
              onClick={() => {
              ...
              className="max-h-67 w-full rounded-xl md:w-1/2 object-cover cursor-pointer"
            />
            <div className="md:w-1/2 md:pl-6 flex flex-col gap-2 mt-4 md:mt-0">
              <h2 className="text-gray-500">{room.hotel.city}</h2>
              <p
                onClick={() => {
                  navigate(`/rooms/${room._id}`);
                  window.scrollTo(0, 0);
             ...
             {/* Room Amenities */}
               <div className="flex flex-wrap items-center mt-3 gap-4">
                 {room.amenities.map((item, index)=> (
                    <div key={index} className="flex items-center gap-2 px-3 py-3 rounded-lg bg-[#F5F5FF]/70">
     ...
     <div className="bg-white w-80 border border-gray-300 max-lg:mb-8 min-lg:mt-16">
        {/* This is where filter options or a sidebar could go */}
