...
const MyBookings = ()=> {
    ...
    return (
        <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            Plan your trips seeemlessly with just a few clicks" align="left"/>
                   ...
                   md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t">
                        ...
                        <div className="flex flex-col md:flex-row">
                            ...
                            <div className="flex items-center gap-1 text-sm text-gray-500">
                             ...
                             <div className="flex items-center gap-1 text-sm text-gray-500">
                                <img src={assets.guestsIcon} alt="guest-icon" className="" />
                                <span className="">Guest: {booking.guests}</span>
                            </div>
